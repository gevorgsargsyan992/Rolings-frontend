  ...
  const features = [
    {
      ...
      title: t("personal-page"),
      description: t("personal-page-desc"),
    },
    {
      icon: (
        <svg
    ...
    <section className="py-16 px-4 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <Text className="text-blue-500 text-sm font-semibold mb-2">
            {t("why-choose-us")}
          </Text>
