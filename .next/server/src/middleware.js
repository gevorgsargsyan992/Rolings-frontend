...
var i18nConfig = __webpack_require__(751);
...
const localeDetector_1 = __importDefault(__webpack_require__(644));
const validateConfig_1 = __importDefault(__webpack_require__(737));
function i18nRouter(request, config) {
    ...
    if (!pathLocale) {
        ...
        if (cookieLocale && cookieLocale !== pathLocale) {
            ...
            if (serverSetCookie !== "always") {
                response = NextResponse.redirect(new URL(getPathForLocale(cookieLocale), request.url));
        ...
        if (!prefixDefault && pathLocale === defaultLocale) {
            response = NextResponse.redirect(new URL(getPathForLocale(defaultLocale), request.url));
        }
        const setCookie = ()=>{
    ...
    response.headers.set("x-next-i18n-router-locale", resolvedLocale || defaultLocale);
    return response;
}
...
exports.S = void 0;
const i18nRouter_1 = __importDefault(__webpack_require__(973));
...
const intl_localematcher_1 = __webpack_require__(293);
const negotiator_1 = __importDefault(__webpack_require__(137));
